public class Patient extends Person {
   ...
   //Constructor
   public Patient(int patientID, String firstName, String lastName, int roomNumber, 
      ...
      super(patientID, firstName, lastName, roomNumber, emergencyContact, emergencyNumber,
